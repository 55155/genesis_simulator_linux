...
# )
fn = '/home/seongjin/Desktop/Seongjin/genesis_simulation_on_linux/My_asset/Crank_slider_system_V1_description/urdf/Crank_slider_system_V1.xml'
...
cam.stop_recording(save_to_filename = config['file_path']['video']+'/'+fn.split('/')[-1]+"_failcase_20250912.mp4")