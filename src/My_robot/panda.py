...
# )
fn = '/home/seongjin/Desktop/Seongjin/Genesis/genesis/assets/urdf/panda_bullet/panda.urdf'
...
cam.stop_recording(save_to_filename = config['file_path']['video']+'/'+fn.split('/')[-1]+".mp4", fps = 60)