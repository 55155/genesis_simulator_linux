...
def generate_launch_description():
    pkg_share = launch_ros.substitutions.FindPackageShare(package='Crank_slider_system_description').find('Crank_slider_system_description')
    default_model_path = os.path.join(pkg_share, 'urdf/Crank_slider_system.xacro')
    default_rviz_config_path = os.path.join(pkg_share, 'config/display.rviz')
    world_path = os.path.join(pkg_share, 'worlds/room.sdf')
    # sdf_path = os.path.join(pkg_share, 'models/urdf/Crank_slider_system/model.sdf')
    ...
    spawn_entity = launch_ros.actions.Node(
        ...
        arguments=['-entity', 'Crank_slider_system', '-topic', 'robot_description'],
        parameters=[{'use_sim_time': use_sim_time}],
        output='screen'
    )
